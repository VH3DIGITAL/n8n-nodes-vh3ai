...
export const invoicesOperations: INodeProperties[] = [
	{
		...
		options: [
			...
			},
			{
				...
				description: 'Raise a new invoice. Requires currencyCode (ISO 4217, e.g. GBP, USD, EUR). Link to a job, job group, OR contact via additional fields. After creation, add lines via Create Invoice Line Item, then Mark Invoice Sent.',
			},
			{
		...
		options: [
			{
				...
				type: 'number',
				default: 0,
				description: 'Contact ID to associate with the invoice',
			},
			{
